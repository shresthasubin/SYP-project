...
const hallRegister = async (req, res) => {
    try {
        const { hall_name, hall_location, hall_contact, license, capacity } = req.body
        const registeredDate = new Date()

        const hallPoster = req.file?.hallPoster

        if (!hall_name || !hall_location || !hall_contact || !license || !capacity) {
...
const hallUpdate = async (req, res) => {
    try {
        ...
        const { hall_name, hall_location, hall_contact, isActive, license, capacity, registeredDate } = req.body
